...
function listStates() {
  return Object.keys(STATE_CITIES).sort();
}

function getCities(state) {
  if (!state || !STATE_CITIES[state]) return null;
  return [...STATE_CITIES[state]].sort();
}

module.exports = { listStates, getCities, STATE_CITIES };
